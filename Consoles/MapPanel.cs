...
namespace RS_Roguelike.Consoles
{
    class MapPanel : ConsoleList
    {
        ...
        public MapPanel()
        {
            StatsConsole = new StatusPanel(24, 17);
            ViewConsole = new Console(56, 17);
            ViewConsole.FillWithRandomGarbage(); // Temp to see if it's on.
            MessageConsole = new MessagePanel(80, 6);

            // Set up the message header to be as wide as the screen but only one character high.
            ...
            messageHeaderConsole.SetGlyph(56, 0, 193); // This makes the border match the character.
