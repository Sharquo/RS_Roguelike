    ...
    public class CommandSystem
    {
        ...
        private static int ResolveAttack(Actor attacker, Actor defender, StringBuilder attackMessage)
        {
            ...
            foreach (TermResult termResult in attackResult.Results)
            {
                ...
                // Compare the value to 100 minus the attack chance and add a hit if it is greater.
        ...
        private static int ResolveDefense(Actor defender, int hits, StringBuilder attackMessage, StringBuilder defenseMessage)
        {
            ...
            if (hits > 0)
            {
                ...
                // Roll a number of 100 sided dice euqal to the Defense value of the defending Actor.
                ...
                foreach (TermResult termResult in defenseResult.Results)
                {
                    ...
                    // Compare the value to 100 minus the defense chance and block if it is greater.
                    if (termResult.Value >= 100 - defender.DefenseChance)
                    {
                        blocks++;
                    }
                }
                defenseMessage.AppendFormat("results in {0} blocks.", blocks);
            }
            else
            {
        ...
        private static void ResolveDeath(Actor defender)
        {
            ...
            {
                Game.MessageLog.Add($" {defender.Name} was killed! BLAT BLAT");
            }
