...
namespace RS_Roguelike
{
    public class MapGenerator
    {
        ...
        // Generate a new map that is a simple open floor plan with walls around the outside.
        public DungeonMap CreateMap()
        {
            // Initialize every cell in the map by setting walkable, transparency, and explored to be true.
